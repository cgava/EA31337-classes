...
/**
 * @file Strategy.enum.h
 * @brief Includes Strategy's enums.
 */
...
/** @enum ENUM_OPEN_METHOD
    @brief Enumeration for strategy bitwise open methods. */
enum ENUM_OPEN_METHOD {
...
/** @enum  ENUM_STRATEGY_ACTION
    @brief Enumeration for strategy actions. */
enum ENUM_STRATEGY_ACTION {
 ...
 *  @brief Enumeration for strategy conditions. */
enum ENUM_STRATEGY_CONDITION {
 ...
 *  @brief Defines enumeration for strategy parameters.*/
enum ENUM_STRATEGY_PARAM {
 ...
 *  @brief Enumeration for strategy periodical statistics. */
enum ENUM_STRATEGY_STATS_PERIOD {
  EA_STATS_DAILY,
  EA_STATS_WEEKLY,
  EA_STATS_MONTHLY,
