 ...
 *  @brief Defines enumeration for price price base calculations (open, close, high, low, median, typical, weighted).
 * 
...
/** Defines enumeration for Chart class parameters (ID, symbol, timeframe, timeframe index).
 */
